<template>
  <div v-if="show">
    <el-form label-position="top">
      ...
      <template v-if="data.custom== true">
          <tagConfig :data="data" />
      </template>
      <template v-else>
        ...
        <el-form-item label="高度" v-if="data.options.hasOwnProperty('height')">
          <el-input v-model="data.options.height"></el-input>
        </el-form-item>

        <el-form-item label="大小" v-if="data.options.hasOwnProperty('size')">
          宽度：
...
import tagConfig from "./widgetConfig/tagConfig";
